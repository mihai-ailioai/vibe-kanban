...
**For multiple files (recommended):** Click the triple dot icon at the top right of the task and select **Open in [Your IDE]** to open all workspace files in your chosen IDE, where you can resolve all conflicts at once.

<Steps>
<Step title="Open your IDE">
  Click the triple dot icon at the top right and select **Open in [Your IDE]** to access all workspace files, or use **Open in Editor** from the banner for individual files.
</Step>
