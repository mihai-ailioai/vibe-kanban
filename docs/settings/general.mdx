...
4. Your editor opens either the project directory or the task workspace on the remote machine

This works both when you open an entire project and when you open a task workspace.
